...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('index/css/font.css')); ?>">
...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form method="post" class="layui-form" action="<?php echo e(url('doreg')); ?>">
            <input name="username" placeholder="Username"  type="text" lay-verify="required" class="layui-input" >
            <input name="email" placeholder="Email"  type="text" lay-verify="required" class="layui-input" >
            <hr class="hr15">
            <?php echo e(csrf_field()); ?>

            <input name="password" lay-verify="required" placeholder="password"  type="password" class="layui-input">
            <input name="qpassword" lay-verify="required" placeholder="Confirm password"  type="password" class="layui-input">
            <hr class="hr15">
...
<?php /**PATH D:\phpstudy_pro\WWW\la\blog\resources\views/login/reg.blade.php ENDPATH**/ ?>