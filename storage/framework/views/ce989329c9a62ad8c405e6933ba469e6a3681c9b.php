...
<html lang="zxx">
  ...
  <body>
    ...
    <div class="container">
      <div class="row justify-content-center" style="background:url(<?php echo e(asset('31.png')); ?>);background-size:150% ;background-repeat: no-repeat; ;height:850px">
        <div class="col-md-10 col-lg-12 p-b-60">
          <div class="p-t-30">
                ...
                <form class="form-horizontal" role="form" style="margin-left:150px;border:1px solid rgb(230,230,230);width:800px;padding:60px;background:rgb(240,240,240,0.8);border-radius:20px;color:black" action="<?php echo e(url('doreg2')); ?>" method="post">
...
</html><?php /**PATH D:\phpstudy_pro\WWW\la\blog\resources\views/login/userreg.blade.php ENDPATH**/ ?>