...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<?php echo e(url('user/upd')); ?>" method="post" enctype="multipart/form-data">
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="<?php echo e($data->title); ?>">
                      </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="<?php echo e($data->fen); ?>">
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                   ...
                   <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          ...
                          autocomplete="off" class="layui-input" value="<?php echo e($data->semester); ?>">
                      </div>
                      <div class="layui-form-mid layui-word-aux">
                          <span class="x-red">*</span>
                      </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                         <textarea  name="content" style="width: 400px;height: 100px"  class="layui-input"><?php echo e($data->content); ?></textarea> 
                      </div>
                      <div class="layui-form-mid layui-word-aux">
...
<?php /**PATH D:\phpstudy_pro\WWW\la\blog\resources\views/user/edit.blade.php ENDPATH**/ ?>