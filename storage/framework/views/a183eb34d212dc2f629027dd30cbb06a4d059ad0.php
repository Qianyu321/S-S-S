...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="<?php echo e(url('user/new')); ?>" method="post" enctype="multipart/form-data">
                 ...
                 <input type="hidden" name="t" value="<?php echo e($t); ?>">
                  <div class="layui-form-item">
...
<?php /**PATH D:\phpstudy_pro\WWW\la\blog\resources\views/user/add.blade.php ENDPATH**/ ?>