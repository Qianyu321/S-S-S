            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <!-- 二级菜单 -->
                        <dd>
                            <a onclick="xadmin.open('Person','<?php echo e(url('user/editu')); ?>')">Edit Password</a></dd>
                          
                        <dd>
                            <a href="<?php echo e(url('logout')); ?>">Logout</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item to-index">
                    <a href="<?php echo e(url('')); ?>">Index</a></li>
            </ul>
        </div>
                ...
                <?php if(auth()->guard()->guest()): ?>
                     ...
                     <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('User','<?php echo e(url('user/index5')); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>User</cite></a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('Account','<?php echo e(url('user/index')); ?>')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>List</cite></a>
                            </li>
...
</html><?php /**PATH D:\phpstudy_pro\WWW\la\blog\resources\views/layouts/index.blade.php ENDPATH**/ ?>