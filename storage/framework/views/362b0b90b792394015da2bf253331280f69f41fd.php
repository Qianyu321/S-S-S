...
<div class="container">
  <div class="row">
  <h2 class="smt">List</h2>
 
    <div class="row">
  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="col-sm-4 cs" >
 <img src="../images/<?php echo e($v->times); ?>" alt="" style="width:100%;height:250px;border-radius:20px 20px 0px 0px ">  

    <div class="col-sm-12" style="text-align:left;padding:10px">
      <b style="font-size:14px;text-align:left"><a href="detail/<?php echo e($v->id); ?>"><?php echo e($v->title); ?></a></b>
        <p></p>
      <p><?php echo e($v->content); ?></p>
      <p>$ <?php echo e($v->semester); ?></p>
...
<?php /**PATH D:\phpstudy_pro\WWW\la\blog\resources\views/index/index.blade.php ENDPATH**/ ?>