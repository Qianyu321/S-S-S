...
<div class="col-sm-4 cs" >
 <img src="../images/{{$v->times}}" alt="" style="width:100%;height:250px;border-radius:20px 20px 0px 0px ">  

    <div class="col-sm-12" style="text-align:left;padding:10px">
      <b style="font-size:14px;text-align:left"><a href="detail/{{$v->id}}">{{$v->title}}</a></b>
        <p></p>
      <p>{{$v->content}}</p>
      <p>$ {{$v->semester}}</p>
