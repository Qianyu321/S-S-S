...
<div class="container">
  <div class="row">
    ...
    <div class="row">
     ...
     <img src="../images/{{$data->times}}" alt="" style="width:100%;height:550px;border-radius:20px 20px 0px 0px ">  
  ...
  <tbody>
    <tr>
      <td> Name：{{$data->title}}</td> 
    </tr>
   
      <td>Tag：{{$data->fen}}</td> 
    </tr>
     
       <td>Content：{{$data->content}}</td>
    </tr>
