...
<html lang="zxx">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('')}}static/css/fontawesome-all.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}static/css/material-design-iconic-font.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}static/css/animate.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}static/css/hamburgers.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}static/css/animsition.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}static/css/util.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('')}}static/css/stylesheet.css">
  </head>
  <body>
        ...
        <div class="topbar">
          <div class="utf-content-topbar container h-100">
            <div class="utf-left-topbar">
              <a href="{{url('login')}}" class="utf-left-topbar-item">Admin</a>
              ...
              <ul class="main-menu">
                 <li class="main-menu-active">
                  <a href="{{url('')}}">Home</a>
                     ...
                     <li class="main-menu-active" style="margin-left:900px">
                  <a href="{{url('userlogin')}}">Login</a>
                 
                </li>
                 <li class="main-menu-active">
                  <a href="{{url('userreg')}}">Register</a>
    ...
    <div class="container">
      <div class="row justify-content-center" style="background:url({{asset('31.png')}});background-size:150% ;background-repeat: no-repeat; ;height:850px">
        <div class="col-md-10 col-lg-12 p-b-60">
          <div class="p-t-30">
                <div class="how2 how2-cl2 flex-s-c">
                  <h3 class="f1-m-2 cl3 tab01-title" style="color:white">Register</h3>
                </div>
                <br>
              
                <form class="form-horizontal" role="form" style="margin-left:150px;border:1px solid rgb(230,230,230);width:800px;padding:60px;background:rgb(240,240,240,0.8);border-radius:20px;color:black" action="{{url('doreg2')}}" method="post">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-12">
      <input type="text" class="form-control" name="email" id="lastname" placeholder="Email">
    </div>
  </div>
<br>
     <div class="form-group">
  ...
  <div class="form-group">
    ...
    <script src="{{asset('')}}static/js/animsition.min.js"></script>
